"""Train and evaluate a bounded categorical trajectory model for N=8.
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--data-dir",
        type=Path,
        default=project_dir / "generate_traj" / "data" / "sz_N8",
    )
    parser.add_argument(
        "--checkpoint",
        type=Path,
        default=experiment_dir / "n8_grugrid_best.pt",
    )
